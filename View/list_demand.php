                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($demande['nom_demandeur']) ?>
                                <?= htmlspecialchars($demande['prenom_demandeur']) ?></td>
                            <td><?= htmlspecialchars($demande['type_acte']) ?></td>
                            <td>
                                <?php if ($demande['type_acte'] === 'naissance'): ?>
                                <?= htmlspecialchars($demande['nom_beneficiaire']) ?>
                                <?= htmlspecialchars($demande['prenom_beneficiaire']) ?>
                                <?php elseif ($demande['type_acte'] === 'mariage'): ?>
                                <?= htmlspecialchars($demande['nom_mari']) ?>
                                <?= htmlspecialchars($demande['prenom_mari']) ?> &
                                <?= htmlspecialchars($demande['nom_femme']) ?>
                                <?= htmlspecialchars($demande['prenom_femme']) ?>
                                <?php elseif ($demande['type_acte'] === 'deces'): ?>
                                <?= htmlspecialchars($demande['nom_defunt']) ?>
                                <?= htmlspecialchars($demande['prenom_defunt']) ?>
                                <?php else: ?>
                                -
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <a href="details_demand.php?code_demande=<?= urlencode($demande['code_demande']) ?>&id=<?= urlencode($id) ?>"
                                    class="btn">Voir</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
