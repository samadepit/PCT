    ...
    <header>
        <div class="bg-orange  justify-content-center p-2 mb-2" style="height: 70px;">
            <div class="container text-start text-white d-flex align-items-center  justify-content-between">
                <p class="m-0  fancy-text"><strong>Votre mairie, accessible en un clic.</strong></p>
        ...
        <div class="bg-dark text-dark mb-2">
            <nav class="navbar navbar-expand-lg navbar-dark bg-light">
                <div class="container">
                    ...
                    <a class="navbar-brand text-color fw-bold" href="./dashboard.php">E-Mairie</a>
                        ...
                        <div>
                            <ul class="navbar-nav">
                                <li class="nav-item mx-2">
                                    <a class="nav-link text-dark hover:text-primary" href="./dashboard.php">Accueil</a>
                                </li>
                                <li class="nav-item mx-2">
                                    <a class="nav-link text-dark hover:text-primary" href="./demande.php">Demande</a>
                                </li>

                                <!-- <li class="nav-item mx-2">
                                <a class="nav-link text-dark hover:text-primary"
                                    href="./consulter_demande.php">Suivie</a>
                               </li> -->
