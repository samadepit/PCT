            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="nom_beneficiaire" name="nom_beneficiaire" pattern="^[A-Za-zÀ-ÿ\s\-]+$" required>
                    </div>
                    <div class="form-group">
                        <label for="prenom_beneficiaire">Prénom *</label>
                        <input type="text" id="prenom_beneficiaire" name="prenom_beneficiaire" pattern="^[A-Za-zÀ-ÿ\s\-]+$" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group full-width">
                        ...
                        <input type="text" id="lieu_naissance" name="lieu_naissance" pattern="^[A-Za-zÀ-ÿ\s\-]+$" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="prenom_mere" name="prenom_mere" pattern="^[A-Za-zÀ-ÿ\s\-]+$" required>
                    </div>
                    <div class="form-group">
                        <label for="profession_mere">Profession *</label>
                        <input type="text" id="profession_mere" name="profession_mere" pattern="^[A-Za-zÀ-ÿ\s\-]+$" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="statut_mariage" name="statut_mariage" pattern="^[A-Za-zÀ-ÿ\s\-]*$">
                    </div>
                </div>
