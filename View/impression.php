...
<body>
    ...
    <div class="document" id="print-zone">
        ...
        <div class="section-center">N° <strong><?= htmlspecialchars($acte['code_demande']) ?></strong> du
            <?= date('d/m/Y', strtotime($acte['naissance_date_creation'])) ?> du Registre</div>
        ...
        <div class="info-block">
            ...
            est né(e) <strong><?= htmlspecialchars($acte['nom_beneficiaire']) ?>
                <?= htmlspecialchars($acte['prenom_beneficiaire']) ?></strong><br><br>
            à <strong><?= htmlspecialchars($acte['lieu_naissance']) ?></strong><br><br>
            Fils de : <strong><?= htmlspecialchars($acte['nom_pere']) ?>
                <?= htmlspecialchars($acte['prenom_pere']) ?></strong><br>
            Profession : <strong><?= htmlspecialchars($acte['profession_pere']) ?></strong><br><br>
            Et de : <strong><?= htmlspecialchars($acte['nom_mere']) ?>
                <?= htmlspecialchars($acte['prenom_mere']) ?></strong><br>
        ...
        <div class="footer">
            ...
            <strong><?= htmlspecialchars($acte['officier_nom']) ?>
                <?= htmlspecialchars($acte['officier_prenom']) ?></strong> <br>
            <?php
              $baseUrl = "/PCT";
            ?>
            <img src=  <?= $baseUrl . htmlspecialchars( $acte['signature']) ?> alt="signature">
        </div>
    </div>
    ...
    <div class="document" id="print-zone">
        ...
        <div class="section-center">N° <strong><?= htmlspecialchars($acte['code_demande']) ?></strong> du
            <?= date('d/m/Y', strtotime($acte['mariage_date_creation'])) ?> du Registre</div>

        <div class="section-title">EXTRAIT D'ACTE DE MARIAGE</div>

        <div class="info-block">
            Le mariage a été célébré le
            <strong><?= date('d F Y', strtotime($acte['mariage_date_creation'])) ?></strong><br>
            à <strong><?= htmlspecialchars($acte['lieu_mariage']) ?></strong><br><br>

            Entre :<br>
            <strong><?= htmlspecialchars($acte['nom_mari']) ?> <?= htmlspecialchars($acte['prenom_mari']) ?></strong>,
            né le <?= date('d/m/Y', strtotime($acte['date_naissance_epoux'])) ?> à
            <?= htmlspecialchars($acte['lieu_naissance_epoux']) ?><br>
            Profession : <strong><?= htmlspecialchars($acte['profession_epoux']) ?></strong><br><br>

            Et :<br>
            <strong><?= htmlspecialchars($acte['nom_epouse']) ?>
                <?= htmlspecialchars($acte['prenom_epouse']) ?></strong>, née le
            <?= date('d/m/Y', strtotime($acte['date_naissance_epouse'])) ?> à
            <?= htmlspecialchars($acte['lieu_naissance_epouse']) ?><br>
    ...
    <div class="document" id="print-zone">
        ...
        <div class="section-center">N° <strong><?= htmlspecialchars($acte['code_demande']) ?></strong> du
            <?= date('d/m/Y', strtotime($acte['deces_date_creation'])) ?> du Registre</div>
        ...
        <div class="info-block">
            ...
            Nom : <strong><?= htmlspecialchars($acte['nom_defunt']) ?>
                <?= htmlspecialchars($acte['prenom_defunt']) ?></strong><br>
            Genre : <strong><?= htmlspecialchars($acte['genre']) ?></strong><br>
            Né(e) le <?= date('d/m/Y', strtotime($acte['defunt_date_naissance'])) ?> à
            <?= htmlspecialchars($acte['defunt_lieu_naissance']) ?><br>
